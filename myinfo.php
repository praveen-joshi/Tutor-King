...
{
$eml=$_SESSION['steml'];
$query="select * from student where eid='$eml' ";
...
<ul class="nav justify-content-end">
  <li class="nav-item dis">
    <a href="exp.php?eid=<?php echo $row[3];?>" class="nav-link lin">Go back</a>
  </li>
</ul>
</nav>
    ...
    <div class="container">
		<div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="<?php echo $row[7] ?>" class="img-fluid" style="border-radius: 100px;height:200px;width:200px">
...
<div class="tab-content text-left" id="myTabContent">
  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><br><h6>Shri Vaishnav Vidhyapeeth Vishwavidhyalaya</h6>
  <p><em>B.Tech, Information Technology</em><br>
  <small><em class="text-muted">2017-Present</em></small></p>
  </div>
  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"><br>
	<h5>Home Town</h5><hr class="style11">
	<p><em><?php echo $row[4] ?></em></p><br>
	<p><em><?php echo $row[5] ?></em></p><br>
  </div>
  <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab"><br>
	<h5>E-mail</h5>
	<hr class="style11">
	<p><em><?php echo $row[3] ?></em></p>
  </div>
 </div><br>

  <a href="student-edit.php?email=<?php echo $email?>"><button class="button" ><span>Edit profile</span></button></a>
  </div>
            </div>
          </div>
        </div>
